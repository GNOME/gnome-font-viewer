 ...
 * FontInscription:
 *
 * Shows font preview in a fixed-size area with a constant baseline distance.
 */
                 ...
                 int            *baseline)
{
    ...
    metrics = font_inscription_get_font_metrics (self);
 ...
 * @text: (nullable): The text to display.
 *
 * Creates a new `FontInscription` with the given text.
 *
